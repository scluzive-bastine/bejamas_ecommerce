          ...
          <main className="py-8 sm:py-20 relative px-4 sm:px-8">
              <div className="mt-10 block lg:flex justify-between md:space-x-10">
                  <div className="flex-grow">
                      <div className="flex justify-between items-center mb-10 md:mb-0 border-b border-gray-200 pb-2">
                          <div>
                              ...
                              <div className="block md:flex justify-between items-center">
                                  <div className="flex space-x-3 items-center">
                                    <div className="relative h-[60px] w-[120px] md:h-[100px] md:w-[200px]">
                                      <Image src={item.src} objectFit="cover" layout="fill" alt={item.name} />
                                    </div>
                                      <div>
                                  ...
                                  <div className="flex space-x-4 md:space-x-10 items-center mt-2 md:mt-0">
                                      <div className="flex space-x-2 items-center">
                                          <div className="cursor-pointer p-2 hover:bg-gray-100 transition duration-150 rounded" onClick={() => decreaseItemInCart(item.id)}>
                                              <MinusIcon className="h-5" />
                                          </div>
                                          <div>
                                              <div className="border border-gray-200 p-2 font-semibold text-black rounded w-10 h-10 text-center">{ item.quantity} </div>
                                          </div>
                                          <div className="cursor-pointer p-2 hover:bg-gray-100 transition duration-150 rounded" onClick={() => increaseItemInCart(item.id)}>
                                      ...
                                      <div className="cursor-pointer text-red-500 hover:text-red-700 transition duration-150" onClick={() => deleteItemFromCart(item.id)}>
                ...
                <div className="w-full md:w-80 p-4 bg-gray-200 hidden lg:flex items-center justify-center h-full">
                    <div>
                        <h1 className="text-2xl text-center font-bold mb-8">Checkout</h1>
                          <div>
